...
git-gen-changelog - Creates a ChangeLog from a git log
...
B<git-changelog> is a small Perl script that reads the output of git-log
...
B<git-changelog> is very simple and should be tweaked to fit your use case.
